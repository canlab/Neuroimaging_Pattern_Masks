...
atlas_name = 'tian_3t_s2_fsl6_2mm';
...
parcellation_file = which('Tian_Subcortex_S2_3T.nii.gz');
...
atlas_obj.orthviews('unique',which('MNI152NLin6ASym_T1_1mm.nii.gz'));
...
if dosave
    ...
    o2 = canlab_results_fmridisplay([], 'multirow', 1, 'overlay', which('MNI152NLin6ASym_T1_1mm.nii.gz'));
    brighten(.6)
