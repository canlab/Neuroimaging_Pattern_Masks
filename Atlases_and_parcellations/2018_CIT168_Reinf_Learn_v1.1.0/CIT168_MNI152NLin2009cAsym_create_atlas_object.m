...
atlas_name = 'CIT168_MNI152NLin2009cAsym_subcortical_v1.1.0';
...
parcellation_file = which('CIT168toMNI152-2009c_prob.nii.gz');  
...
labels = {'Put' 'Cau' 'NAC' 'BST_SLEA' 'GPe' 'GPi' 'SNc' 'RN' 'SNr' 'PBP' 'VTA' 'VeP' 'Haben' 'Hythal' 'Mamm_Nuc' 'STH'};
label_descriptions = {'Putamen',...
    'Caudate',...
    'Nucleus Accumbens',...
    'Extended Amygdala: Bed Nuclei of the Stria Terminalis (BNST) and Sublenticular Extended Amygdala (SLEA)',...
