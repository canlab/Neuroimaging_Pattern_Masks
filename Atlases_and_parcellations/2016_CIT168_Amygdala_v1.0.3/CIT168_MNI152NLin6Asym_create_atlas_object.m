...
atlas_name = 'CIT168_MNI152NLin6Asym_amygdala_v1.0.3';
...
parcellation_file = which('CIT168_pAmyNuc_1mm_MNI.nii.gz');
gunzip(parcellation_file)
parcellation_file = which('CIT168_pAmyNuc_1mm_MNI.nii');
