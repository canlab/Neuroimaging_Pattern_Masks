...
wb_command -volume-label-import subctx_atlas.nii.gz subctx_atlas.txt subctx_atlas.label.nii
wb_command -cifti-create-label canlab_2023_2mm.dlabel.nii \
    -volume subctx_atlas.label.nii hcp_cifti_subctx_labels.nii.gz \
