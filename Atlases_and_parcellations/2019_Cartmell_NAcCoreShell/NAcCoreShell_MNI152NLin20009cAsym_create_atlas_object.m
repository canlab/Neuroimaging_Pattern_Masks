...
atlas_name = 'NAcCoreShell_MNI152NLin2009cAsym';
...
pmap = fmri_data({which('lh-presumed-core_MNI152NLin2009cAsym.nii.gz'),...
    which('lh-presumed-shell_MNI152NLin2009cAsym.nii.gz'),...
    which('rh-presumed-core_MNI152NLin2009cAsym.nii.gz'),...
    which('rh-presumed-shell_MNI152NLin2009cAsym.nii.gz')});
...
if dosave
    ...
    o2 = canlab_results_fmridisplay([], 'full hcp','overlay',which('fmriprep20_template.nii.gz'));
    brighten(.6)
