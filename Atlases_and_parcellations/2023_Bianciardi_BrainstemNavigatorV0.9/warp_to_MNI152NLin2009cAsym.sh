...
# this script maps from MNI152NLin6Asym space to MNI152NLin2009cAsym space
...
singularity exec --bind $THIS_DIR --cleanenv \
    ...
    $THIS_DIR/Atlases_and_parcellations/2023_Bianciardi_BrainstemNavigatorV0.9/warp_to_MNI152NLin2009cAsym0.sh
