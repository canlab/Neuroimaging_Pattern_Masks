...
atlas_name = 'bianciardi_fsl6_hires';
...
bianciaTbl = readtable(which('bianciardi_hires_labels.csv'));
labels = {};
labels_2 = {};
label_descriptions = {};
...
orthviews(bianciaAtlas, 'unique', 'overlay', which('fsl6_hcp_template.nii'));
figure;
% Convert to regions
% -----------------------------------------------------------------------
