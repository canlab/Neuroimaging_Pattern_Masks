...
tbl = readtable('src/label_descriptions.csv','Delimiter',',');
lbl_descrip = [cellfun(@(x1)([x1, ' (Left)']), tbl.label_descriptions, 'UniformOutput', false);  ...
    cellfun(@(x1)([x1, ' (Right)']), tbl.label_descriptions, 'UniformOutput', false)];
labels_2 = strrep([cellfun(@(x1)([x1 ,' L']), tbl.labels_2, 'UniformOutput', false); ...
    cellfun(@(x1)([x1 ,' R']), tbl.labels_2, 'UniformOutput', false)],' ','_');
labels_3 = [cellfun(@(x1)([x1 ,'_L']), tbl.labels_3, 'UniformOutput', false); ...
    cellfun(@(x1)([x1 ,'_R']), tbl.labels_3, 'UniformOutput', false)];
