...
if strcmp(SCALE,'fine')
    ...
    hipp_amyg_dil = hipp_amyg_dil.merge_atlases(amygdalar_fiber_structures, 'always_replace');
...
nii.dat = canlab.probability_maps;
nii.fullpath = sprintf('%s_scaffold.nii', canlab.atlas_name);
nii.write();
gzip(sprintf('%s_1mm.nii', nii.atlas_name))
delete(sprintf('%s_1mm.nii', nii.atlas_name));