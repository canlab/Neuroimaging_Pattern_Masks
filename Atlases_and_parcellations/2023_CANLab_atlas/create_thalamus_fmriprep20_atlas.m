...
cit168 = load_atlas('CIT168_fmriprep20');
...
ref_obj = fmri_data(which('MNI152NLin2009cAsym_T1_1mm.nii.gz'));
...
savefile = 'thalamus2023_fmriprep20_combined_atlas_object.mat';
