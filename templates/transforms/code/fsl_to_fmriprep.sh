...
CompositeTransformUtil --disassemble $srcRoot/MNI152NLin6Asym_to_MNI152NLin2009cAsym_subctx_Composite.h5 \
    fsl_to_fmriprep_subctx

mv [0-9][0-9]*fsl_to_fmriprep_subctx* ../ants/
...
$c3d -src $REF_FSL -ref $REF_FMRIPREP -itk ../ants/00_fsl_to_fmriprep_subctx_AffineTransform.mat -ras2fsl \
    -o ../fsl/00_fsl_to_fmriprep_subctx_AffineTransform_mod.mat
wb_command -convert-warpfield -from-itk ../ants/01_fsl_to_fmriprep_subctx_DisplacementFieldTransform.nii.gz \
    -to-fnirt ../fsl/01_fsl_to_fmriprep_subctx_DisplacementFieldTransform_mod.nii.gz $REF_FMRIPREP
