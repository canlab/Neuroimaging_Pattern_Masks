...
orig_nii = ni.load('../../../sandbox/templates/01_fsl_to_fmriprep_DisplacementFieldTransform.nii')
...
for i in range(dat.shape[0]):
    for j in range(dat.shape[1]):
        for k in range(dat.shape[2]):
            ...
            coord[i,j,k,0,:] = this_coord[:3]  # + [1,1,1] # convert to matlab indexing by incrementing by 1
...
ni.save(new_nii,'../../../sandbox/templates/y_01_fsl_to_fmriprep_DisplacementFieldTransform.nii')
